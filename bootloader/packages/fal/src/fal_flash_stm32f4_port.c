...
#include <packages/fal/inc/fal.h>
#include <stm32f4xx.h>
...
static int write(long offset, const uint8_t *buf, size_t size)
{
    ...
    {
        /* write data */
        HAL_FLASH_Program(FLASH_TYPEPROGRAM_BYTE, addr, (uint64_t)(*buf));
...
//const struct fal_flash_dev stm32f4_onchip_flash_bl =
//{
//    .name       = ONCHIP_BL_NAME,
//    .addr       = STM32_FLASH_START_ADRESS_16K,
//    .len        = FLASH_SIZE_BL,
//    .blk_size   = FLASH_SIZE_GRANULARITY_16K,
//    .ops        = {init, read, write, erase},
//    .write_gran = 8
//};
//
//const struct fal_flash_dev stm32f4_onchip_flash_rom =
//{
//    .name       = ONCHIP_ROM_NAME,
//    .addr       = STM32_FLASH_START_ADRESS_64K,
//    .len        = FLASH_SIZE_ROM,
//    .blk_size   = FLASH_SIZE_GRANULARITY_64K,
//    .ops        = {init, read, write, erase},
//    .write_gran = 8
//};
//
//const struct fal_flash_dev stm32f4_onchip_flash_app =
//{
//    .name       = ONCHIP_APP_NAME,
//    .addr       = STM32_FLASH_START_ADRESS_128K,
//    .len        = FLASH_SIZE_APP,
//    .blk_size   = FLASH_SIZE_GRANULARITY_128K,
//    .ops        = {init, read, write, erase},
//    .write_gran = 8
//};
